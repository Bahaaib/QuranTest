...
class _QuranShowState extends State<QuranShow>
  ...
  void initAudioPlayer() {
    ...
    _stateChangedSubscription =
      ...
      setState(() {
        isPlay = state == AudioPlayerState.PLAYING;
      });
    });
  }
  ...
  play(String page) async {
    ...
    audioPlayer.onPlayerCompletion.listen((event) {
      if (widget.sorahNum == null &&
          ...
          position != null) {
        print('I Completed');
        print('isPlay: $isPlay --- duration: ${duration.inMilliseconds}'
            ' ---- postion: ${position.inMilliseconds}');
            ...
            return Container(
              ...
              child: Stack(
                children: <Widget>[
                  ...
                  Visibility(
                      visible: isShowControl || !isPlay, child: TopBar()),
                  _downloadingBar(),
                  _bottomBar(context)
                ],
              ),
  ...
  Widget _quranPages(BuildContext context, Orientation orientation) {
    return InkWell(
      onTap: () => isShowControl = !isShowControl,
                    ...
                    child: InkWell(
                      onTap: () {
                        showDialog(
                            context: context,
                            builder: (BuildContext context) {
                              return localeHelper.lang() == 'ar'
                                  ? _showTafseer(currentPage)
